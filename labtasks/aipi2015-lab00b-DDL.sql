...
CREATE TABLE publishing_house (
    id                INT(10) UNSIGNED AUTO_INCREMENT NOT NULL,
    name              VARCHAR(50) NOT NULL,
    registered_number INT(10) NOT NULL UNIQUE,            
    description       VARCHAR(1000),
...
CREATE TABLE book_presentation (
     ...
     stockpile   INT(6) UNSIGNED NOT NULL,
     KEY (id)
);
...
CREATE TABLE supply_order_header (
    id                    INT(10) UNSIGNED AUTO_INCREMENT NOT NULL,
    ...
    publishing_house_id   INT(10) UNSIGNED NOT NULL,
    KEY (id),
    KEY (identification_number, issue_date)
);
...
CREATE TABLE supply_order_line (
    id                     INT(10) UNSIGNED AUTO_INCREMENT NOT NULL,
    supply_order_header_id INT(10) UNSIGNED NOT NULL,
    book_presentation_id   INT(10) UNSIGNED NOT NULL,
...
CREATE TABLE user (
    id                  INT(10) UNSIGNED AUTO_INCREMENT NOT NULL,
    personal_identifier BIGINT(13) UNSIGNED NOT NULL UNIQUE,
    first_name          VARCHAR(50) NOT NULL,
    last_name           VARCHAR(50) NOT NULL,
...
BEGIN
    ...
    SELECT SUM(sol.quantity * bd.price) INTO result 
      FROM supply_order_header soh, supply_order_line sol, book_presentation bp
     WHERE soh.identification_number = identification_number 
       AND sol.supply_order_id = soh.id 
       AND bp.id = sol.book_presentation_id;
    RETURN result;
END; //
...
BEGIN
      SELECT SUM(calculate_invoice_value(identification_number)) INTO total_invoice_value 
       ...
       WHERE ih.personal_identifier = personal_identifier;
      SELECT identification_number, calculate_invoice_value(identification_number), issue_date 
        FROM invoice_header ih 
       WHERE ih.personal_identifier = personal_identifier
